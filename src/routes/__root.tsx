...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Search, locate, borrow and return college library books with rack and shelf guidance." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Smart Library Book Finder" },
      { property: "og:description", content: "A modern college library system for students." },
